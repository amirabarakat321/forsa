...
/// main search consultation
  ...
  //  Route::get('/project/delete/{id}', 'ProjectController@deleteproject')->name('deleteproject');
    ...
    Route::post('services/edit', 'ProjectController@editservice')->name('editservice')->middleware('can:update');
...
/////tickets
    ...
    Route::get('chatconsul/{id}', 'FirebaseController@consultchat');
...
Route::group(['middleware' =>['delete'] ], function () {
    ...
    Route::get('studiestypes.destroy', 'studyTypeController@destroy');
...
Route::group(['middleware' =>['reader'] ], function () {
    Route::get('consultations.show','ConsultationsController@show');
...
Route::group(['middleware' =>['justadmin'] ], function () {
    /*
     * Users Routes
     * */
...
//    Route::get('consultations/status/{id}', 'ConsultationsController@status');
//    Route::get('chatf', 'ChatController@index');
//    Route::get('/consultations_categories_destroy/{id}', 'ConsultationsCategoriesController@destroy')->middleware('delete');
//
//
//    Route::resource('consultations', 'ConsultationsController');
//
